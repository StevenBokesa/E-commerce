...
<html lang="en">
	...
	<head>
		...
		<title>Goeveni - Register Now</title>
											...
											<div class="login-register-form">
												<form action="Register">
													<div class="form-group">									
														<input class="title-discussion-input" type="text" placeholder="Full Name" name="fullName">
													</div>
													<div class="form-group">									
														<input class="title-discussion-input" type="email" placeholder="Email Address" name="email">
													</div>
													<div class="form-group">									
													...
													<div class="login-link">If you have an account? <a href="login.html">Login Now</a></div>
												</form>											
