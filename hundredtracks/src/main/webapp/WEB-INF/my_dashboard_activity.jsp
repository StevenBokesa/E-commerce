...
<%@ page import="bean.*"%>
<%@ page import="model.*"%><%@ page import ="java.util.List"%>
...
<html lang="en">
	...
	<head>
		...
		<title>Sociallinks - My Dashbaord Activity</title>
				...
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12">
						<nav class="navbar navbar-expand-lg navbar-light bg-dark1 justify-content-sm-start">
							<a class="order-1 order-lg-0 ml-lg-0 ml-3 mr-auto" href="index.html"><img src="images/niniwebsites.png" alt="" width="90px" height="50px"></a>
							...
							<div class="main-posts">											
								...
								<form action="home" method="post">																				
									<div class="activity-group">																					
										...
										<textarea class="add-activity-des" placeholder="What is new, John Doe?" name="post"></textarea>
									</div>
									<div class="activity-button">
										...
										<c:choose>
											...
											<c:forEach var="posts" items="${posts}" varStatus="loopStatus">
											<div class="activity-posts">																											
												<div class="activity-group1">																					
													<div class="main-user-dts1">																					
														...
														<c:choose>
														    <c:when test="${posts.user_id==sessionScope.user_id}">
														        <h4>Me</h4>
														        <span>posted an update at <c:out value="${posts.post_time}" /></span>
														    </c:when>    
														    <c:otherwise>
															   <% Post post = (Post)pageContext.getAttribute("posts"); %>
 															   <h4> <%= new UserDAO().getUserById(post.getUser_id()).getFirst_name() %> </h4>
														       <span>posted an update at <c:out value="${posts.post_time}" /></span>
														    </c:otherwise>
														</c:choose>
														</div>											
												...
												<div class="like-comment-view">
													<div class="left-comments">
														...
														<% Post post = (Post)pageContext.getAttribute("posts"); %>
														<a href="comment?post_id=<%=post.getPost_id()%>" class="like-item lc-left" title="Comment">
												...
												<div class="activity-reply" id="comments" style= display:none;>
													<div class="activity-group1">																					
														<div class="main-user-dts1">																					
												...
												<div class="activity-post-reply">
														...
														<form action="comment" method="post">
															<% Post postg = (Post)pageContext.getAttribute("posts"); %>
															<input type="hidden" name="post_id" value="<%=postg.getPost_id()%>">  
															<input class="areply-post" name="comment" type="text" placeholder="Write a reply">
