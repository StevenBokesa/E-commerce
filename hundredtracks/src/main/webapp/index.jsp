...
<%
	...
	window.location.href = "http://localhost:8080/hundredtracks/login.jsp";
	</script>
    <%
    }
    %>
    ...
    List<EventBean> event=new EventDAO().findAll();
												...
												<div class="event-main-post">
													<div class="event-top">
														<div class="event-top-left">
															<a href="event_detail_view.html"><h4><c:out value="${events.title}"/></h4></a>
														</div>
														<div class="event-top-right">
															<div class="ticket-price">Ticket Price : <span><c:out value="${events.price}"/></span></div>
														...
														<div class="main-photo">
															...
															<div class="post-buttons">
																...
																<div class="right-buttons">
																	<ul class="main-btns">
																		<li><button class="main-btn-link btn-hide" onclick="window.location.href = '#';"><c:out value="${events.seats}"/> Seats</button></li>
															...
															<li>
																<div class="it-items">
																	...
																	<div class="list-text-dt">
																		<span>City</span>
																		<ins><c:out value="${events.city}"/></ins>
																	</div>
																</div>
															</li>
															<li>
																<div class="it-items">
																	...
																	<div class="list-text-dt">
																		<span>Date</span>
																		<ins><c:out value="${events.date}"/></ins>
																	</div>
																</div>
															</li>
															<li>
																<div class="it-items">
																	...
																	<div class="list-text-dt">
																		<span>Time</span>
																		<ins><c:out value="${events.event_start}"/> to <c:out value="${events.event_end}"/></ins>
																	</div>
																</div>
															</li>
															<li>
